...
macro(check_cpuid CHARACTERISTIC VARIABLE)
  ...
  if(DEFINED _CPUID_FORCE AND _CPUID_FORCE)
    ...
    if(CMAKE_CROSSCOMPILING)
      ...
      try_compile(
        CPUID_COMPILE_RESULT ${CMAKE_CURRENT_BINARY_DIR} SOURCES
      ...
      if(NOT _CPUID_CHARACTERISTICS)
        try_run(
          CPUID_RUN_RESULT CPUID_COMPILE_RESULT ${CMAKE_CURRENT_BINARY_DIR}
          ${CMAKE_CURRENT_SOURCE_DIR}/cmake/Modules/cmcpuid.c
          RUN_OUTPUT_VARIABLE CPUID_CHARACTERISTICS)
        set(_CPUID_CHARACTERISTICS
            "${CPUID_CHARACTERISTICS}"
            CACHE INTERNAL "CPU Characteristics")
      endif()
  ...
  if(_CPUID_CHARACTERISTIC_FOUND)
    message(
      "-- Checking for CPU characteristic ${CHARACTERISTIC} - found ${_FORCED}")
  else()
    message("-- Checking for CPU characteristic ${CHARACTERISTIC} - not found")
  endif()
  set(${VARIABLE}
      ${_CPUID_CHARACTERISTIC_FOUND}
      CACHE INTERNAL "Check for CPU characteristic ${CHARACTERISTIC}" FORCE)
endmacro()
